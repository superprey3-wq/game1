...
const variationSets = [
  ...
  { suffix:" с опорой", difficultyShift:-1, note:"Добавьте подушку или устойчивую опору, чтобы уменьшить нагрузку." },
  { suffix:" медленный вариант", difficultyShift:-1, note:"Держите спокойный темп и заранее договоритесь о стоп-сигнале." },
  { suffix:" для смены ролей", difficultyShift:1, note:"Подходит как переход: партнёры могут поменяться более активной ролью." }
];
